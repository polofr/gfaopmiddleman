...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 col-md-3 py-2 cream rounded m-2 ml-md-auto">
      <img src="images/logo_paris_match.png" class="borderless rounded img-thumbnail" alt="Paris Match" >
      <h4>Paris Match</h4>
    ...
    <div class="col-12 col-md-3 py-2 cream rounded m-2">
      <img src="images/logo_le_point.jpeg" class="borderless rounded img-thumbnail" alt="Le Point" >
      <h4>Le Point</h4>
    ...
    <div class="col-12 col-md-3 py-2 cream rounded m-2 mr-md-auto">
      <img src="images/logo_usine_nouvelle.jpeg" class="borderless rounded img-thumbnail" alt="L’Usine nouvelle" >
  ...
  <div class="row">
    <div class="col-12 col-md-3 py-2 cream rounded m-2 ml-md-auto">
      <img src="images/logo_africa_n_1.png" class="borderless rounded img-thumbnail" alt="Africa N1" >
      <h4>Africa N1</h4>
    ...
    <div class="col-12 col-md-3 py-2 cream rounded m-2">
      <img src="images/logo_figaro_sante.png" class="borderless rounded img-thumbnail" alt="Le Figaro Santé" >
