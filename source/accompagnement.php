...
<div class="container">
  ...
  <div class="row text-center">
    <div class="col-12 col-md-5 cream py-2 rounded m-2 ml-md-auto">
      <h4>Les salles d’Unité de préparation et les hottes à flux laminaire</h4>
      <p class="text-justify">Il est indispensable que des salles puissent être dédiées à la préparation des médicaments. En effet, les conditions réglementaires de sécurité ne sont aujourd’hui pas respectées faute d’aménagements spécifiques ; les préparations se font « au pied du lit » La salle doit disposer d’une hotte et de renouvellement d’air afin d’éviter la suspension dans l’air des particules de médicaments en préparation et ainsi leur inhalation par le personnel ou les malades et la perte de substances actives.</p>
    </div>
    <div class="col-12 col-md-5 cream py-2 rounded m-2 mr-md-auto">
      <h4>Les équipements d’anatomopathologie pour mieux assurer les diagnostics</h4>
      <p class="text-justify">Pour confirmer les diagnostics et adapter les traitements au mieux, il serait nécessaire qu’une double lecture soit possible grâce à la télétransmission ( à mettre en place) des unités d’Afrique sub saharienne vers les collègues français mais cela nécessite un microscope permettant d ‘adapter un appareil photo numérique.</p>
    </div>
  </div>
  <div class="row text-center">
    <div class="col-12">
  ...
  <div class="row">
    ...
    <div class="col-md-9 text-justify">
      ...
      Togo, Mali, Centrafrique et Congo.
      <br/>
  ...
  <div class="row py-2 text-center">
    <div class="col-12">
      <h3 class="mx-auto py-1">Le Programme AIDAF</h3>
      <p class="mx-auto py-1"><b>Pour l’amélioration de l’information aux familles et leur accompagnement :<br>
        "L’annonce du diagnostic dans les unités d’oncologie pédiatrique africaines"</b>
      </p>
    </div>
  </div>
  <div class="row">
...
<div class="container">
  <div class="row text-center">
    <div class="col-12">
      <h3 class="mx-auto py-2">Un Plaidoyer pour le cancer des enfants en Afrique</h3>
      <b>Le cancer de l’enfant, un problème de santé publique qui commence à mobiliser les personnalités politiques et les organismes internationaux.</b>
    </div>
  </div>
  <div class="row py-3">
    <div class="col-12 col-md-3 text-center">
