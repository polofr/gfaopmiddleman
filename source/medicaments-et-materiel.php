...
<div class="container py-4">
  <div class="row text-justify py-1">
    ...
    Ce poste de dépenses est le plus lourd sur le plan financier puisqu’il représente environ 160 000 euros par an. Cependant cet effort reste encore actuellement indispensable pour certains pays.
  ...
  <div class="row text-center py-1">
    <div class="col-sm-6 p-4">
      <img src="images/medicaments_envoyes_aux_unites_pilotes.png" class="borderless rounded img-thumbnail" alt="graphique des médicaments envoyés aux unités pilotes " >
    </div>
    <div class="col-sm-6 p-4">
      <img src="images/evolution_medicaments_envoyes.png" class="borderless rounded img-thumbnail" alt="évolution graphique des médicaments envoyés" >
    </div>
  </div>
  <div class="row text-center py-1">
    Du petit matériel (seringues, compresses, pompes…) et du matériel d’aménagement pour les unités (lits) est également envoyé par le GFAOP et son partenaire BIP Humanitaire
  </div>
</div>
