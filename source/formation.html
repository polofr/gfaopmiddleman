...
<div class="container">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="pierre_et_jean_michon_au_togo.jpg" class="borderless rounded img-thumbnail" alt="Pierre et Jean Michon au Togo" >
    </div>
    <div class="col-md-9 col-12 py-3">
      <h3>• Les Stages</h3>
      D’une durée de 15 jours à 2 mois, en France, au Maroc ou dans certaines unités d’Afrique sub-sahariennes, ces stages sont ouverts à différentes disciplines en vue d’acquérir les compétences nécessaires à la pratique de l’oncologie pédiatrique.
      Toutes les disciplines médicales et paramédicales sont concernées.
    </div>
  </div>
  <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="Ndella_Diouf_et_Guy_Leverger.jpeg" class="borderless rounded img-thumbnail" width="300px" alt="Ndella Diouf et Guy Leverger" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="formation_oncologie_avec_guy_leverger_au_togo.jpg" class="borderless rounded img-thumbnail" width="600px" alt="formation oncologie avec Guy Leverger au Togo" >
    </div>
    <div class="col-md-9 col-12 py-3">
    ...
    <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="promotion_DUCP.jpg" class="borderless rounded img-thumbnail" width="600px" alt="promotion DUCP" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="formation_collegiale.jpg" class="borderless rounded img-thumbnail" width="600px" alt="la promotion attentive pendant les cours" >
    </div>
    <div class="col-md-9 col-12 py-3">
      <h3>• Les formations collégiales</h3>
      Les formations collégiales ont lieu à l’occasion des rencontres du GFAOP (Conseil d'Administration et Assemblée Générale). Ces réunions rassemblent les médecins des unités pilotes du Maghreb et d’Afrique sub-saharienne.
      Elles constituent un temps fort de formation par les échanges d’expériences qu’elles permettent.
    </div>
  </div>
  <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="mission_ formation.jpg" class="borderless rounded img-thumbnail" width="300px" alt="lecture d'une radiographie en formation" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="ouverture_unite_pilote_niger.jpg" class="borderless rounded img-thumbnail" width="300px" alt="les responsables d’Unités Pilotes en formation" >
    </div>
    <div class="col-md-9 col-12 py-3">  
  ...
  <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="actionstage2.jpg" class="borderless rounded img-thumbnail" width="300px" alt="les responsables d’Unités Pilotes en formation TODO" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="formation_data_manager.jpg" class="borderless rounded img-thumbnail" width="300px" alt="formation data manager" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="formation_infimier.jpg" class="borderless rounded img-thumbnail" width="600px" alt="2 infirmiers" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded">
    <div class="col-md-3 col-12 text-center">
      <img src="conference_douleur_et_soins.jpg" class="borderless rounded img-thumbnail" width="300px" alt="conference douleur et soins" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify">
    <div class="col-md-3 col-12 text-center">
      <img src="formation_personnel_de_sante.jpg" class="borderless rounded img-thumbnail" width="300px" alt="personnel de santé en formation" >
    </div>
    <div class="col-md-9 col-12 py-3">
  ...
  <div class="row text-justify cream rounded mb-2">
    <div class="col-md-3 col-12 text-center">
      <img src="Fatou_et_Fouss.jpg" class="borderless rounded img-thumbnail" width="300px" alt="Fatou et Fouss traitant l'oeil" >
    </div>
    <div class="col-md-9 col-12 py-3">
      <h3>Les autres spécialités médicales</h3>
      Si des chirurgiens et des pathologistes sont présents dans tous les pays d’Afrique sub-saharienne francophone, ils sont en nombre insuffisant et doivent faire face à des activités multiples, la cancérologie pédiatrique n’en représentant qu’une petite partie. 
