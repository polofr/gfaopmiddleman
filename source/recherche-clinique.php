  ...
  <div class="row">
    <div class="col-12 col-md-6 text-justify">
      ...
      <ul class="mx-auto">
        ...
        <li>Les leucémies aigües lymphoblastiques</li>
        <li>La maladie de Hodgkin</li>
        <li>Le lymphome de Burkitt</li>
      </ul>
    </div>
...
<hr class="separator">
<div class="container">
  <h3 class="text-center py-3">Les Comités De Tumeurs</h3>
  <div class="row text-center">
    <div class="col-12 col-md-3 cream rounded m-2 ml-md-auto">
      <h4 class="py-1">Comité Burkitt</h5>
      <h6>Coordinateur : Siham Cherkaoui (Casablanca, Maroc)</h6>
      <h6>Data manager : Marie-Anne Raquin (IGR, France)</h6>
      <h6>Expert: Catherine Patte (IGR, France)</h6>
      <h6>Membres : Maria El Kababri (Rabat), Fousseyni Traoré (Bamako), Chantal Bouda (Ougadougou), Claude Moreira (Dakar)</h6>
    </div>
    <div class="col-12 col-md-3 cream rounded m-2">
      <h4 class="py-1">Comité Néphroblastome</h5>
      <h6>Coordinateur : Claude Moreira (Dakar, Sénégal)</h6>
      <h6>Data manager : Brenda Mallon (IGR, France)</h6>
      <h6>Secrétaire : Jean Jacques Yao Atteby (Treichville, Côte d’Ivoire)</h6>
      <h6>Expert: Catherine Patte (IGR, France)</h6>
      <h6>Membres : Pr Mohamed Khattab (Rabat), Sonia Kaboret (Ougadougou)</h6>
    </div>
    <div class="col-12 col-md-3 cream rounded m-2 mr-md-auto">
      <h4 class="py-1">Comité Rétinoblastome</h5>
      <h6>Coordinateur : Fousseyni Traoré (Bamako, Mali)</h6>
      <h6>Expert : Pierre Bey (Curie, France)</h6>
    </div>
  </div>
  <div class="row text-center">
    <div class="col-12 col-md-3 cream rounded m-2 ml-md-auto">
      <h4 class="py-1">Comité Lymphome Hodgkinien</h5>
      <h6>Coordinateur :  Fatou Binetou Akonde (Dakar), Faten Fedilha (Tunis)</h6>
...
<div class="container">
  ...
  <div class="row text-justify">
    ...
    <div class="col-12 col-md-6">
      ...
      <p>Pour les rétinoblastomes, les résultats à Bamako, seule unité pilote pour laquelle nous ayons un peu de recul avec 112 cas observés depuis le lancement du programme en octobre 2011, montrent une augmentation des formes intraoculaires : 70% des cas actuellement avec un taux de guérison de plus de 90. On observe aussi un début des traitements conservateurs pour les formes bilatérales. Par ailleurs, tous les enfants énucléés ont eu une prothèse.</p>
    </div>
    <div class="col-12 col-md-6">
