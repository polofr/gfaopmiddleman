  ...
  <div class="row">
    ...
    <div class="col-md-2 text-center">
      <a href="http://fondation-sanofi-espoir.com/">
        <img src="../images/logo_sanofi.jpg" class="borderless rounded img-thumbnail" width="300" alt="sanofi espoir foundation" >
      </a>
      <h5>Sanofi Espoir Foundation</h5>
    </div>
    <div class="col-md-2 text-center">
      <a href="http://www.total.fr/home.html">
        <img src="../images/logototal.jpg" class="borderless rounded img-thumbnail" width="300" alt="Total foundation" >
      </a>
      <h5>TOTAL</h5>
    </div>
    <div class="col-md-2 text-center">
  ...
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="http://www.ligue-cancer.net/">
        <img src="../images/Logo_LIGUE.jpg" class="borderless rounded img-thumbnail" width="70" alt="Ligue against Cancer" >
      </a>
    ...
    <div class="col-md-2 text-center">
      <img src="../images/logoagir.png" class="borderless rounded img-thumbnail" width="100" alt="Marrocan foundation AGIR" >
      <h5>AGIR in Maroc</h5>
    </div>
    <div class="col-md-2 text-center">
  ...
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="http://www.avh.asso.fr/">
        <img src="../images/logovalentinhauy.jpg" class="borderless rounded img-thumbnail" width="300" alt="Valentin Haüy foundation" >
      </a>
  ...
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="https://www.facebook.com/fondationcalissaikama/">
        <img src="../images/logocalissa.png" class="borderless rounded img-thumbnail" width="90" alt="Calissa Ikama foundation" >
      </a>
