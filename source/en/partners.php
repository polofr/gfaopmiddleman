...
<div class="container cream rounded">
  <div class="row text-center">
    <h2 class="mx-auto py-4">Our Partners</h2>
    <h5 class="mx-auto py-1">The GFAOP is a founding member of ALIAM, a UICC member, a UNAPECLE member and a SFCE partner</h5 >
  </div>
  ...
  <div class="row">
    <div class="col-12">
      <h5 class="text-center py-3">A big thank to all of our partners for their engagement</h5>
    </div>
  </div>
  <div class="row">
    <div class="col-md-2 text-center">
    ...
    <div class="col-md-2 text-center">
      <a href="http://fondation-sanofi-espoir.com/">
        <img src="../images/logo_sanofi.jpg" class="borderless rounded img-thumbnail" width="300px" alt="sanofi espoir foundation" >
      </a>
      <h5>Sanofi Espoir Foundation</h5>
    </div>
    <div class="col-md-2 text-center">
      <a href="http://www.total.fr/home.html">
        <img src="../images/logototal.jpg" class="borderless rounded img-thumbnail" width="300px" alt="Total foundation" >
      </a>
      <h5>TOTAL</h5>
    </div>
    <div class="col-md-2 text-center">
      <a href="http://www.contrelecancer.ma/fr/">
        <img src="../images/logolalla.jpg" class="borderless rounded img-thumbnail" width="300px" alt="Lalla Salma foundation" >
      </a>
    ...
    <div class="col-md-2 text-center">
      <img src="../images/logosiim.jpg" class="borderless rounded img-thumbnail" width="90px" alt="SIIM" >
      <h5>SIIM</h5>
    </div>
  </div>
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="http://www.ligue-cancer.net/">
        <img src="../images/Logo_LIGUE.jpg" class="borderless rounded img-thumbnail" width="70px" alt="Ligue against Cancer" >
      </a>
    ...
    <div class="col-md-2 text-center">
      <img src="../images/logoagir.png" class="borderless rounded img-thumbnail" width="100px" alt="Marrocan foundation AGIR" >
      <h5>AGIR in Maroc</h5>
    </div>
    <div class="col-md-2 text-center">
  ...
  <div class="row">
    ...
    <div class="col-md-2 text-center">
      ...
      <h5>Association Soleterre in Ivory Coast</h5>
    </div>
    <div class="col-md-2 text-center">
    ...
    <div class="col-md-2 text-center">
      <a href="http://fondation.edf.com/">
        <img src="../images/logo_fondation_edf.jpeg" class="borderless rounded img-thumbnail" width="120px" alt="EDF foundation" >
      </a>
      <h5>Fondation EDF</h5>
    </div>    
  </div>
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="http://www.avh.asso.fr/">
        <img src="../images/logovalentinhauy.jpg" class="borderless rounded img-thumbnail" width="300px" alt="Valentin Haüy foundation" >
      </a>
    ...
    <div class="col-md-2 text-center">
      ...
      <h5>Assocation "VICTOiR" in Togo</h5>
    </div>
    <div class="col-md-2 text-center">
  ...
  <div class="row">
    <div class="col-md-2 text-center">
      <a href="https://www.facebook.com/fondationcalissaikama/">
        <img src="../images/logocalissa.png" class="borderless rounded img-thumbnail" width="90px" alt="Calissa Ikama foundation" >
      </a>
      <h5>Calissa Ikama Foundation in Congo</h5>
    </div>
    <div class="col-md-2 text-center">
  ...
  <div class="row">
    <ul>
      <li>And our numerous private donors !</li>
    </ul>
  </div>
</div>
